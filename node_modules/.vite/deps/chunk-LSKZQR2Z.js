...
for (e = "2.77.2", t = {}, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0; s < i.length; s++)
  t[i.charCodeAt(s)] = s;
var e;
var t;
var i;
  ...
  return async function(e2, t) {
    const { options: i, unsetOptions: s } = await async function(e3, t2) {
      ...
      const i2 = pl(e3.plugins), { options: s2, unsetOptions: n3 } = function(e4) {
        ...
        return async (t3, i3) => i3.options && await i3.options.call({ meta: { rollupVersion: "2.77.2", watchMode: e4 } }, await t3) || t3;
...
*/
//# sourceMappingURL=chunk-LSKZQR2Z.js.map
